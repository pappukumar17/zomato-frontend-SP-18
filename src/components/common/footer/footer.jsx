                                ...
                                <section className="social-links">
                                    ...
                                    <div className="main-links">
                                        <section className="links">
                                            <Link to="https://in.linkedin.com/company/zomato" target="_blank" className="footer-link"><GrLinkedin size={25} style={{ color: "black", borderradius: "20px" }} /></Link>
                                            <Link to="https://www.instagram.com/zomato/" target="_blank" className="footer-link"><AiFillInstagram size={30} color="black" /></Link>
                                            <Link to="https://twitter.com/zomato" target="_blank" className="footer-link"><AiFillTwitterCircle size={30} color="black" /></Link>
                                            <Link to="https://www.youtube.com/zomato" target="_blank" className="footer-link"><TiSocialYoutubeCircular size={33} color="black" /></Link>
                                            <Link to="https://www.facebook.com/zomato" target="_blank" className="footer-link"><BsFacebook size={25} color="black" /></Link>
                                        </section>
                                    </div>
                                        ...
                                        <div className="download-link-2">
                                            ...
                                            <div className="ios-2">
                                                <Link to="https://bnc.lt/download-zomato-ios" target="_blank">
                                                    <img className="ios-image" src={"https://b.zmtcdn.com/data/webuikit/9f0c85a5e33adb783fa0aef667075f9e1556003622.png"} alt="" />
                                                </Link>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="mobile-information">
                                <section className="mobile-social-links">
                                    ...
                                    <div className="mobile-download-link-2">
                                        ...
                                        <Link to="https://bnc.lt/download-zomato-ios" target="_blank">
                                                <img className="mobile-ios-image" src={"https://b.zmtcdn.com/data/webuikit/9f0c85a5e33adb783fa0aef667075f9e1556003622.png"} alt="" />
                                            </Link>
                                        </div>
                                    </div>
                                </section>
