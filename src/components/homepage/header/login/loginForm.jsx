    ...
    return (
        <>
            <form method='POST' className='modal-form' >
                <div className="mb-3">
                    <input type="text" className="form-control" htmlFor="contact" id="contact" placeholder="Phone / Email" />
                </div>
                <div className="mb-3">
                    <input type="password" className="form-control" htmlFor="password" id="loginpassword" placeholder="Password" />
                </div>
